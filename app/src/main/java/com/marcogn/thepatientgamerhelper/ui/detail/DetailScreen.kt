...
import com.marcogn.thepatientgamerhelper.domain.export.suggestedReviewFileName
...
fun DetailScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(review?.title.orEmpty(), maxLines = 1, overflow = TextOverflow.Ellipsis) },
                navigationIcon = {
